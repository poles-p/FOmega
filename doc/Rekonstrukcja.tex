...
niech $\rho$ będzie podstawieniem zawierającym tylko zmienne rodzajowe. Wówczas zachodzie
\[
...
\begin{lemat}
Niech $\rho$ jest podstawieniem, a $(\sigma, S)$ $\beta$-unifikatorem konstruktorów $(\rho T_1, \rho T_2)$.
...
Teza wynika wprost z załorzenia indukcyjnego o lematów \ref{lunif1} i \ref{lunif2}.
