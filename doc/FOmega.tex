...
\begin{lemat}
Niech $A$ i $B$ będą podzbiorami zbioru zmiennych typowych kwantyfikowanych abstrakcją, niech $\theta$ będzie podstawieniem.
Wówczas zachodzi
\[
...
\begin{lemat}
Niech $A$ będzie podzbiorem zbioru zmiennych typowych kwantyfikowanych abstrakcją, niech $\theta$ i~$\rho$ będą podstawieniami, oraz
...
\begin{lemat}
Niech $A$ będzie podzbiorem zbioru zmiennych typowych kwantyfikowanych abstrakcją, niech $\theta$ będzie dowolnym podstawieniem,
